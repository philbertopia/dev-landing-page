  ...
  return (
    <main className='w-screen h-screen relative'>
      <div className='flex items-center w-full h-full bg-cover bg-center' style={{ backgroundImage: "url(/main-bg.webp)" }}>
        <div className='px-5 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]'>
          <h1 className='text-[50px] md:text-[50px] text-white font-semibold'>
          ...
          <p className='text-gray-200 hidden xl:block'>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium fuga consequuntur quasi ut accusantium distinctio esse id porro temporibus ratione, quis pariatur quas inventore, mollitia placeat adipisci tenetur nihil blanditiis.
          </p>
      ...
      <div className='absolute flex bottom-10 z-[20] right-5 flex-col md:hidden gap-5'>
        <Link href="/my-skills" className='rounded-[20px] group relative bg-blue-500 px-5 py-3 text-lg text-white max-w-[200px]'>
          Learn more
        </Link>
      ...
      <div className='absolute bottom-0 right-0 z-[2]'>
        <Image 
          ...
          height={300}
          width={300}
          className='absolute right-55 top-60'
        />
